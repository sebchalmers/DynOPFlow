...
Runs a Monte Carlo simulation of NMPC loops with random wind profiles, various horizon length, and not forecast uncertainty
...
HorizonSetup = {'Min' : 6, 'Max' : 48, 'Step': 3, 'Nrealization' : 12}
...
for realization in range(HorizonSetup['Nrealization']):
                       ...
                       dWind.append([rand.normalvariate(0,0.2) for k in range(Nprofile)])
...
while Horizon < HorizonSetup['Max']:
                       ...
                       for realization in range(HorizonSetup['Nrealization']):
                                              ...
                                              Net.LBInputProfiles['Wind',:,'dWindSpeed']   = dWind[realization]
                                              Net.UBInputProfiles['Wind',:,'dWindSpeed']   = dWind[realization]
